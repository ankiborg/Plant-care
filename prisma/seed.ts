...
const species: {
...
}[] = [
  {
    ...
    toxicToPets: true,
    notes: "Gullranka. Very forgiving; let the top few cm of soil dry out.",
  },
  {
    commonName: "Monstera",
  ...
  },
  {
    ...
    defaultSoil: "STANDARD",
    toxicToPets: false,
    notes: "Ampellilja. Easy; brown tips usually mean tap-water minerals or dryness.",
  },
  {
  ...
  },
  {
    ...
    defaultSoil: "DRAINING",
    toxicToPets: false,
    notes: "Rotate regularly so it grows evenly; let topsoil dry between waterings.",
  },
  {
    commonName: "Swedish ivy (karlbergare)",
    ...
    defaultSoil: "STANDARD",
    toxicToPets: false,
    notes: "Classic mormorsväxt — fast-growing and near-indestructible; pinch tips to keep it bushy.",
  },
  {
    commonName: "Basil",
